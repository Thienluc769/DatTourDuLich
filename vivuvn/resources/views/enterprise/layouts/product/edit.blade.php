<?php
// if (isset($request->old('key', 'default'))) {
//     dd($request->old());
// }
?>
@extends('enterprise.parentLayouts.master')
@section('title', 'vivuvn | Edit Tour')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-2 align-items-center">
                                    <input type="number" class="form-control" name="tour_time" placeholder="Days">
                                    <span>ngày</span>
                                    <input type="number" class="form-control" name="tour_time_night"
                                        placeholder="Nights">
                                    <span>đêm</span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="departure_date" id="departure_date" min=""
                ...
                <div class="form-section mb-5">
                    ...
                    <div id="schedule-container">
                        <div class="schedule-day mb-4">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="day1" rows="3"
                                    placeholder="Nhập chi tiết lịch trình ngày 1..."></textarea>
                            </div>
                        </div>
                    </div>
...
<script>
    function addDay() {
        ...
        <div class="form-group mb-3">
            <input type="text" class="form-control" name="day_title[]" placeholder="Day title">
        </div>
        <div class="form-group">
            <textarea class="form-control" name="day_description[]" rows="3" placeholder="Day description"></textarea>
        </div>
    `;
